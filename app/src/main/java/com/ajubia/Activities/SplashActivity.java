...
public class SplashActivity extends AppCompatActivity {
    ...
    public  void checkResult()
    {
        ...
        ModuleRequest moduleRequest=new ModuleRequest(Constant.token,Constant.ota_domain,Constant.domain_type,listener,errorListener);
        RequestQueue requestQueue = SingleTonRequest.getmInctance(this).getRequestQueue();

        moduleRequest.setRetryPolicy(new DefaultRetryPolicy(50000,
                DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        requestQueue.add(moduleRequest);
