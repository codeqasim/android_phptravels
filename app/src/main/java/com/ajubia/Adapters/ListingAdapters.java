...
import com.ajubia.Models.ExpediaExtra;
...
import com.ajubia.Network.Parser.CarRequest;
import com.ajubia.Network.Parser.DetailRequest;
import com.ajubia.Network.Parser.ExpediaDetailRequest;
import com.ajubia.Network.Parser.OfffersRequest;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(!check_ean.equals("offers")) {
            ...
            if(check_ean.equals("cars")) {
                ...
                if (check_ean.equals("ex_hotel")) {
                    ...
                    mViewHolder.rating_text.setText(" " + currentListData.getStarsCount() + "/10");
                    mViewHolder.price.setText(currentListData.getcurrCode() + " " + currentListData.getcurrSymbol() + " "
                            + currentListData.getPrice());
                }
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    DetailRequest checkDetial=new DetailRequest(context,currentListData.getHotelSlug(),hotel);
